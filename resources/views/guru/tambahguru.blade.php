...
<body>
    <div class="container my-5 col-6">
        <h2>Tambah Guru</h2>
        <form method="POST" action="{{ route('tambah-dataguru') }}" enctype="multipart/form-data">
            @csrf
